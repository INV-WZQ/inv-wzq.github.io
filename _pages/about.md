...
- 2026.01: 🎉 [SparseD](https://arxiv.org/abs/2509.24014) was accepted by ICLR’26. 
- 2025.11: 🌟 Three papers ([DualParal](https://arxiv.org/abs/2505.21070), [SAMCL](https://arxiv.org/abs/2412.05012) and [Jump-teaching](https://arxiv.org/abs/2405.17137)) were accepted by AAAI’26.
...
<div class='paper-box'>
  <div class='paper-box-image'>
    <div>
      ...
      <video src='https://github.com/INV-WZQ/ReactiveGWM/blob/page/static/data/demo_other_overlay_chosen/all_demo_web.mp4?raw=true' width="100%" autoplay loop muted playsinline></video>
    </div>
  </div>
...
<ul>
  <li>
    ...
    <div><i>Kangye Ji, Fei Cheng, <strong>Zeqing Wang</strong>, Qichang Zhang, Bohu Huang. </i></div>
  </li>
</ul>
